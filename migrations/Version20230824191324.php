...
final class Version20230824191324 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , ru INTEGER DEFAULT NULL, uniqid VARCHAR(255) NOT NULL, milieu VARCHAR(32) DEFAULT NULL, CONSTRAINT FK_3A771143DE95C867 FOREIGN KEY (sector_id) REFERENCES sector (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');

 ...
 */
final class Version20230824181542 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , ru INTEGER DEFAULT NULL, uniqid VARCHAR(255) NOT NULL, CONSTRAINT FK_3A771143DE95C867 FOREIGN KEY (sector_id) REFERENCES sector (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
